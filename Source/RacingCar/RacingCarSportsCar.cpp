...
#include "RacingCarSportsCar.h"
#include "RacingCarSportsWheelFront.h"
#include "RacingCarSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ARacingCarSportsCar::ARacingCarSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingCarSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingCarSportsWheelRear::StaticClass();
