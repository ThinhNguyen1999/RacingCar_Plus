...
#include "RacingCarOffroadCar.h"
#include "RacingCarOffroadWheelFront.h"
#include "RacingCarOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ARacingCarOffroadCar::ARacingCarOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingCarOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingCarOffroadWheelRear::StaticClass();
